...
Public Class Form1
    ...
    Private Sub LoadToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LoadToolStripMenuItem.Click
        ...
        While RDR.Read
            ...
            C.tel = Convert.ToString(IIf(RDR.IsDBNull(RDR.GetOrdinal("Phone")), "", RDR.Item("Phone")))
            C.FAX = Convert.ToString(IIf(RDR.IsDBNull(RDR.GetOrdinal("Fax")), "", RDR.Item("Fax")))
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '' Change this line...
        CN = New SqlConnection("data source=RODRIGOCUNH3311\SQLEXPRESS;integrated security=true;initial catalog=Northwind")
    ...
    Private Sub SubmitContact(ByVal C As Contact)
        CMD.CommandText = "INSERT Customers (CustomerID, CompanyName, ContactName, Address, " & _
                          "City, Region, PostalCode, Telephone, Country) " & _
                          "VALUES (@CustomerID, @CompanyName, @ContactName, @Address, " & _
                          "@City, @Region, @PostalCode, @Telephone, @Fax, @Country) "
